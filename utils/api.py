...
class Google_maps_api():
    ...
    """Метод для создания новой лоакции"""
    @staticmethod
    def create_new_place():
        ...
        print(post_url)
        reuslt_post = Http_methods.post(post_url, json_for_create_new_place)
        print(reuslt_post.text)
        return reuslt_post

    """Метод для проверки новой лоакции"""
